...
const getEndpoint = async (endpoint: string, opt: void | number | number[] | object) => {
  ...
  try {
    ...
    // When the number of IDs in the requested list is 1, the API returns not a list but a single object data, which is unified here
